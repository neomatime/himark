...
/* HOME HERO canvas IIFE removed when the cinematic 300-frame scroll
   hero was retired in favour of the editorial centered hero from
   the mockup design (rounded card + glass pill nav + architectural
   photograph). The .hero-canvas + .hero-spacer DOM elements that
   this code queried no longer exist in home.html. The 300 JPEGs
   under images/hero-scroll/ are left in place for now — separate
